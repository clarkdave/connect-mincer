 ...
 *
 * Optionally, a manifest can be passed in, which will allow this to be used for production too.
 * 
 * @param  {[type]} manifest A manifest data object, generated from Mincer.Manifest.compile()
 * @return {[type]}          Connect middleware which will compile and dispatch assets
 */
middleware.createServer = function(manifest) {
